    ...
    return (
      <Html lang="fr">
        <Head>
          ...
          <link
            rel="preload"
            href="/fonts/bunch/Bunch-Medium.woff2"
            as="font"
            type="font/woff2"
            crossOrigin="anonymous"
          />
          <link
            rel="preload"
            href="/fonts/bunch/Bunch-SemiBold.woff2"
            as="font"
            type="font/woff2"
            crossOrigin="anonymous"
          />
          <link
            rel="preload"
            href="/fonts/bunch/Bunch-Bold.woff2"
            as="font"
            type="font/woff2"
            crossOrigin="anonymous"
          />
          <link
            rel="preload"
            href="/fonts/bunch/Bunch-ExtraBold.woff2"
            as="font"
            type="font/woff2"
            crossOrigin="anonymous"
          />
          <link
            rel="preload"
            href="/fonts/bunch/Bunch-Heavy.woff2"
            as="font"
            type="font/woff2"
            crossOrigin="anonymous"
          />
